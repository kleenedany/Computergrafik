...
(function Mesh$Members () {
  ...
  var $S07 = function () {
    return ($S07 = JSIL.Memoize(new JSIL.MethodSignature($asm0E.TypeRef("System.Single"), [$asm0E.TypeRef("System.Single")]))) ();
  };
  ...
  function Mesh_CreateScene () {
    ...
    $S03().CallVirtual("Add", null, expr_71, $T0A().CreateCylinder(5, 10, 8));
  ...
  function Mesh_RenderAFrame () {
    this._baseTransform.Rotation = $S00().Construct($S07().CallStatic($T0E(), "MinAngle", null, $T0F().get_TimeSinceStart()), $S07().CallStatic($T0E(), "MinAngle", null, $T0F().get_TimeSinceStart()), $S07().CallStatic($T0E(), "MinAngle", null, $T0F().get_TimeSinceStart()));
    this._baseTransform.Translation = $S00().Construct($S07().CallStatic($T0E(), "MinAngle", null, $T0F().get_TimeSinceStart()), $S07().CallStatic($T0E(), "MinAngle", null, $T0F().get_TimeSinceStart()), $S07().CallStatic($T0E(), "MinAngle", null, $T0F().get_TimeSinceStart()));
    (this.RenderCanvas$RC$value).Clear($T10().$Flags("Color", "Depth"));
    (this.RenderCanvas$RC$value.View = $T11().CreateTranslation(0, 0, 30).MemberwiseClone());
