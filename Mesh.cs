...
namespace Fusee.Tutorial.Core
{
    public class Mesh : RenderCanvas
    {
        ...
        {
           // Cylinder Rotation
            _baseTransform.Rotation = new float3(M.MinAngle(TimeSinceStart), M.MinAngle(TimeSinceStart), M.MinAngle(TimeSinceStart));
            _baseTransform.Translation = new float3(M.MinAngle(TimeSinceStart), M.MinAngle(TimeSinceStart), M.MinAngle(TimeSinceStart));
